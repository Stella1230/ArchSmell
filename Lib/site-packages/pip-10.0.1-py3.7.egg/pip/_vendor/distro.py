...
def lsb_release_info():
    ...
    See `lsb_release command runtime`_ for details about these information
    items.
    """
...
def lsb_release_attr(attribute):
    """
    Return a single named information item from the lsb_release command runtime
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * ``include_lsb`` (bool): Controls whether the
          `lsb_release command runtime`_ is included as a data source.
    ...
    def lsb_release_attr(self, attribute):
        ...
        runtime data source of the Linux distribution.
    ...
    def _lsb_release_info(self):
        """
        Get the information items from the lsb_release command runtime.
    ...
    def _parse_lsb_release_content(lines):
        """
        Parse the runtime of the lsb_release command.

        Parameters:

        * lines: Iterable through the lines of the lsb_release runtime.
                 Each line must be a unicode string or a UTF-8 encoded byte
                 string.
