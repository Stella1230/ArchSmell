...
def main():
    ...
    with open('{}/issue_list.json'.format(args.output), 'w') as f:
        f.write(json.dumps(issue_list))

if __name__ == '__main__':
    main()
    # issue_list = 'issues/HDFS/'
    # gitlog = 'gitlog/hadoop-hdfs/gitlog.json'
    # gitlog_pattern = "HDFS-{nbr}\D|#{nbr}\D"
    # issue_list = find_bug_fixes(issue_list, gitlog, gitlog_pattern)
