...
def readCSV(project_name,filename,col_ca,col_nof):
    """
...
if __name__ == '__main__':
    ...
    project_name = "caffe"
    json_filename = r"D:\Desktop\PyCharm-project\arch-smell\data\caffe3.json"
    csv_filename = r"D:\Desktop\PyCharm-project\arch-smell\data\datasets(3.30).csv"
    basepath = "D:\\Desktop\\1\\depstest\\data\\caffe\\"
    output_dir = "runtime\\" + project_name + ".json"
    col_ca = 2
    col_nof = 4
    vertexes,edges,variables = readJson(json_filename,basepath)
    changed_files = readCSV(project_name,csv_filename,col_ca,col_nof)
